<?php
require_once '../controllers/InvoiceDashboardController.php'; // Include the controller

$controller = new InvoiceDashboardController();
$controller->checkLogin(); // Ensure admin is logged in

$data = $controller->getInvoiceStats(); // Fetch invoice data
?>
